                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-4 pb-2">
                                                <label class="form-label" for="form3Examplev2">Employee Personal ID</label>
                                                <input type="text" required v-model="employees.personalIdNumber" id="form3Examplev2" class="form-control form-control" />
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-4 pb-2">
                                                <div class="form-outline">
                                                    <label class="form-label" for="form3Examplev2">Day of Birth</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-4 pb-2">
                                                <div class="form-outline">
                                                    <label class="form-label" for="form3Examplev2">Postal Code</label>
