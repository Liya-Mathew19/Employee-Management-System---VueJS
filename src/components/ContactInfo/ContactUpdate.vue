        ...
        <div class="col-lg-12 col-md-12">
            <div class="card" style="min-height: 485px">
                <div class="card-header card-header-text">
                    ...
                    <h4 class="card-title">UPDATE EMPLOYEE CONTACT PERSON INFORMATION</h4>
                    </div>
                    <hr>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="p-5">
                                                            ...
                                                            <div class="mb-4 pb-2">
                                                             ...
                                                             <button type="button" class="btn btn-warning btn-lg float-right mt-2 mb-2" v-on:click="editContact()">SUBMIT</button>                                          
                                                        </div> 
                                                    </div>
                                                </div>
                                            </div>
...
export default {
  ...
  methods: {   
    getEmployeeById(id){
        ...
        this.employees.cfirstName=response.data.cfirstName,
        this.employees.cmiddleName=response.data.cmiddleName,
        this.employees.clastName=response.data.clastName,
        this.employees.ccellularPhone=response.data.ccellularPhone,
        this.employees.chomePhone=response.data.chomePhone,
        this.employees.ccity=response.data.ccity,
        this.employees.caddress=response.data.caddress
    ...
    editContact() {
      ...
      ContactService.updateContact(data)
        .then(response => {
          ...
          alert("Employee contact data updated successfully!!");
